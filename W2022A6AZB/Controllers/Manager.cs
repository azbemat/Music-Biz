// ************************************************************************************
// WEB524 Project Template V3 2221 == 9d6e01db-885f-45a9-9f6f-4932ef337f6f
    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<Track, TrackWithAlbumViewModel>();
                ...
                cfg.CreateMap<EntityModels.ArtistMediaItem, Models.ArtistMediaItemBaseViewModel>();
                cfg.CreateMap<EntityModels.ArtistMediaItem, Models.ArtistMediaItemContentViewModel>();
        ...
        public IEnumerable<ArtistBaseViewModel> ArtistGetAll()
        {
            ...
            var sortedArtist = ds.Artists.OrderBy(artist => artist.Name);

            return mapper.Map<IEnumerable<Artist>, IEnumerable<ArtistBaseViewModel>>(sortedArtist);
        ...
        public ArtistBaseViewModel ArtistGetById(int id)
        {
            ...
            var artist = ds.Artists.Include("Albums").SingleOrDefault(i => i.Id == id);
        ...
        // add album for the known artist
        public AlbumBaseViewModel AlbumAdd(AlbumAddViewModel newItem)
        {
            ...
            else
            {
                ...
                addedItem.Artists.Add(artist);

                // Adding Coordinator username
        ...
        // add media item for the known artist
        ...
        // Get one with collection of media item info
        public ArtistWithMediaInfo ArtistGetByIdWithMediaItemInfo(int id)
        {
        ...
        //  Get one media item, including data/bytes
        ...
        public IEnumerable<AlbumBaseViewModel> AlbumGetAll()
        {
            ...
            var sortedAlbums = ds.Albums.OrderBy(album => album.ReleaseDate);

            return mapper.Map<IEnumerable<Album>, IEnumerable<AlbumBaseViewModel>>(sortedAlbums);
        ...
        public IEnumerable<TrackWithAlbumViewModel> TrackGetAllWithDetail()
        {
            return mapper.Map<IEnumerable<Track>, IEnumerable<TrackWithAlbumViewModel>>
                (ds.Tracks.Include("Albums").OrderBy(e => e.Name));
        }

        public TrackWithAlbumViewModel TrackGetById(int id)
        {
            // Attempt to fetch the object
            var o = ds.Tracks.Include("Albums").SingleOrDefault(m => m.Id == id);

            // Return the result, or null if not found
            return (o == null) ? null : mapper.Map<Track, TrackWithAlbumViewModel>(o);
        }
        ...
        public TrackBaseViewModel TrackEditInfo(TrackEditViewModel track)
        {
            // Attempt to fetch the object.
            ...
            else
            {
                ...
                // First, extract the bytes from the HttpPostedFile object
                byte[] photoBytes = new byte[track.AudioUpload.ContentLength];
                track.AudioUpload.InputStream.Read(photoBytes, 0, track.AudioUpload.ContentLength);

                // Then, configure the new object's properties
                obj.Audio = photoBytes;
                obj.AudioContentType = track.AudioUpload.ContentType;

                // Found: Update then save the changes.
                ds.Entry(obj).CurrentValues.SetValues(track);
                ds.SaveChanges();
